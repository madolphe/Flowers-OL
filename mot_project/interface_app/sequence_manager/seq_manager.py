...
class MotParamsWrapper:
    ...
    def __init__(self):
        ...
        self.parameters = {'angle_max': 9, 'angle_min': 3,'radius': 90, 'speed_min': 4, 'speed_max': 4,
                           'episode_number': 0,'nb _target_retrieved': 0, 'nb_distract_retrieved': 0, 'id_session': 0,
                           'presentation_time': 1, 'fixation_time': 1, 'debug': 0, 'secondary_task': 'none',
                           'SRI_max': 2, 'RSI': 1, 'delta_orientation': 45, 'screen_params': 39.116, 'gaming': 1}
    ...
    def sample_task(self, seq):
        ...
        parameters = {
                        ...
                        'tracking_duration': self.values['tracking_time'][act[self.lvls[act['MAIN'][0]]][1]],
                        'probe_duration': self.values['probe_time'][act[self.lvls[act['MAIN'][0]]][2]],
