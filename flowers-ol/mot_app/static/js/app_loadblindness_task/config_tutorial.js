...
let size_end_w = Math.round(0.12*Pos.canvas_height); //in pixel
let size_end_h = Math.round(0.07*Pos.canvas_height); //in pixel
let size_end_text = Math.round(0.02*Pos.canvas_height);
let x_end = Pos.center_x- (size_end_w/2); //in pixel
let y_end = Pos.center_y-Math.round(0.10*Pos.canvas_height)+(size_start_h/2); //in pixel